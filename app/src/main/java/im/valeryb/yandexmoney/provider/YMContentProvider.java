...
import im.valeryb.yandexmoney.provider.base.BaseContentProvider;
import im.valeryb.yandexmoney.provider.categories.CategoriesColumns;

public class YMContentProvider extends BaseContentProvider {
    private static final String TAG = YMContentProvider.class.getSimpleName();
    ...
    public static final String AUTHORITY = "im.valeryb.yandexmoney.provider";
    ...
    protected SQLiteOpenHelper createSqLiteOpenHelper() {
        return YMSQLiteOpenHelper.getInstance(getContext());
    }
